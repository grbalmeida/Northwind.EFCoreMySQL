...
namespace Northwind.EFCore.Data.Migrations
{
    ...
    [Migration("20210911174503_CustomerCustomerDemo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Northwind.EFCore.Models.CustomerCustomerDemo", b =>
                {
                    b.Property<string>("CustomerID")
                        .HasColumnType("VARCHAR(5)");
            ...
            modelBuilder.Entity("Northwind.EFCore.Models.EmployeeTerritory", b =>
                {
                    b.Property<int>("EmployeeID")
                        .HasColumnType("INT(11)");
            ...
            modelBuilder.Entity("Northwind.EFCore.Models.CustomerCustomerDemo", b =>
                {
                    b.HasOne("Northwind.EFCore.Models.Customer", "Customer")
                        .WithMany("CustomerDemos")
                        .HasForeignKey("CustomerID")
                        .HasConstraintName("FK_CustomerDemo_Customer")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Northwind.EFCore.Models.CustomerDemographics", "CustomerDemographics")
                        .WithMany("CustomerDemos")
            ...
            modelBuilder.Entity("Northwind.EFCore.Models.EmployeeTerritory", b =>
                {
                    ...
                    b.HasOne("Northwind.EFCore.Models.Territory", "Territory")
                        .WithMany("EmployeeTerritories")
